...
class Availability(models.Model):
	location=models.CharField(max_length=75,primary_key=True)
	Apos = models.IntegerField()
	Aneg = models.IntegerField()
	Bpos = models.IntegerField()
	Bneg = models.IntegerField()
	ABpos = models.IntegerField()
	ABneg = models.IntegerField()
	Opos = models.IntegerField()
	Oneg = models.IntegerField()
	def __unicode__(self):
